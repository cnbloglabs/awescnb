...
awescnb 是一个专为博客园（CNBlogs）设计的皮肤开发框架，提供了完整的主题开发工具链和丰富的插件生态。通过模块化的架构设计，开发者可以快速创建美观、功能丰富的博客主题。[文档站点](https://www.yuque.com/awescnb)

## ✨ 特性

- 🎨 **丰富的主题库** - 提供多个精心设计的主题，支持自定义配置
- 🔌 **强大的插件系统** - 内置 30+ 实用插件，轻松扩展主题功能
- 📦 **模块化架构** - 核心功能封装为独立包，便于复用和维护
- 🛠️ **完善的开发工具** - 基于 Vite 的快速开发体验，支持热更新
- 🎯 **TypeScript 支持** - 完整的类型定义，提供更好的开发体验
- 📱 **响应式设计** - 所有主题均支持桌面、平板和移动设备
- 🌗 **深色模式** - 内置深色/浅色模式切换支持
- ⚡ **性能优化** - 代码分割、懒加载等优化策略
...
awescnb/
├── packages/             # 核心包
│   ├── core/             # 核心 API，提供主题创建和插件系统
│   ├── loader/           # 皮肤加载器，用于加载和初始化主题
│   ├── options/          # 配置选项管理
...
共享静态资源包，博客园默认 custom 皮肤模板，包含所有主题共享的：
...
**注意：** `shared-assets` 下的文件不可修改，所有主题基于这些基础模板实现。
...
极客风格主题，简洁现代的设计风格，致力于保留博客园原版体验。

### Shadcn

基于 Shadcn UI 设计语言打造的现代化主题，采用 Preact + Tailwind CSS 构建。
